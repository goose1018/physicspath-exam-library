"""Extract DOCX content for 2024 新课标卷 — text + images + paragraph index."""
import json, os
from docx import Document
from docx.oxml.ns import qn
from pathlib import Path

SRC = r"C:/Users/60507/Desktop/17-24物理/2024·高考物理真题/2024年高考物理试卷（新课标）（解析卷）.docx"
...
for rid, rel in rels.items():
    if "image" in rel.reltype:
        ...
        (images_dir / name).write_bytes(target)
...
print(f"images extracted: {len(rid_to_image)} → {images_dir}")
